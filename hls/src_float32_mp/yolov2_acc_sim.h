...
//				TC = MIN(output_w,TC);
				...
				w_base_ptr[0] = w_base_ptr[1] = w_base_ptr[2] = w_base_ptr[3] = Weight_buf+woffset;
				YOLO2_FPGA(in_ptr[i],in_ptr[i],in_ptr[i],in_ptr[i],out_ptr[i],out_ptr[i],
						w_base_ptr[0],w_base_ptr[1],w_base_ptr[2],w_base_ptr[3],Beta_buf+boffset,
					l.c,l.n,l.size,
...
//				TC = MIN(output_w,TC);
				...
				YOLO2_FPGA(in_ptr[i],in_ptr[i],in_ptr[i],in_ptr[i],out_ptr[i],out_ptr[i],
						NULL,NULL,NULL,NULL,NULL,l.c,l.c,

...
int main(int argc,char *argv[])
{
    ...
    if(!fp_w) printf("fopen weightsv2_comb_reorg.bin error\n");
	FILE *fp_b = fopen("biasv2_comb.bin", "rb");
    if(!fp_b) printf("fopen biasv2_comb.bin error\n");
...
////////////////////////////////
	...
	fout = fopen("weightsv2_comb_reorg_ap16.bin","wb");
    if(!fout) printf("fopen weightsv2_comb_reorg_ap16.bin error\n");
	...
	fout = fopen("biasv2_comb_ap16.bin","wb");
    if(!fout) printf("fopen biasv2_comb_ap16.bin error\n");
